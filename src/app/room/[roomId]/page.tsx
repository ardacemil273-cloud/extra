        ...
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500">{totalCount}/{currentRoom?.maxPlayers || '?'} oyuncu</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            <button onClick={handleCopyLink} className="px-3 py-2 rounded-xl border border-white/8 bg-white/3 hover:bg-white/8 text-xs transition-all">
              🔗 Link
            </button>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-4">
            <div className="flex items-center justify-between">
              ...
              <span className="text-sm text-gray-500">{readyCount}/{totalCount} hazır</span>
            </div>
