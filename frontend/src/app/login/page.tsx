  ...
  return (
    <div className="min-h-screen bg-[#080b14] flex items-center justify-center px-4">
      <div className="fixed inset-0 pointer-events-none">
        ...
        <div className="absolute bottom-1/4 right-1/3 w-80 h-80 bg-fuchsia-600/6 rounded-full blur-3xl" />
      </div>
      ...
      >
        ...
        <div className="text-center mb-8">
          <Link href="/" className="inline-flex items-center gap-2">
            <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-purple-600 to-fuchsia-500 flex items-center justify-center text-xl">
              🎮
            </div>
          ...
          <h1 className="text-2xl font-bold text-white mt-4">Tekrar hoş geldin!</h1>
          <p className="text-gray-400 mt-1 text-sm">Hesabına giriş yap ve oynamaya başla</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                placeholder="kullanici veya email@example.com"
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full py-3 rounded-xl font-bold text-white bg-gradient-to-r from-purple-600 to-fuchsia-500 hover:from-purple-500 hover:to-fuchsia-400 disabled:opacity-50 disabled:cursor-not-allowed transition-all active:scale-95 shadow-lg shadow-purple-500/20"
            >
              {isLoading ? (
        ...
        <div className="mt-4 text-center text-sm text-gray-500">
          ...
          {' · '}
          <Link href="/guest" className="text-purple-400 hover:text-purple-300 font-medium">
            Misafir giriş
          </Link>
        </div>
      </motion.div>
