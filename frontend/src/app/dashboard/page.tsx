        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1 space-y-4">
            ...
            <div className="grid grid-cols-2 gap-3">
              <Link
                href="/room/create"
                className="flex flex-col items-center gap-2 p-4 rounded-2xl border border-purple-500/30 bg-purple-500/8 hover:bg-purple-500/15 hover:border-purple-500/50 transition-all group"
              >
              ...
              <Link
                href="/room/join"
                className="flex flex-col items-center gap-2 p-4 rounded-2xl border border-white/8 bg-white/3 hover:bg-white/8 hover:border-white/20 transition-all group"
              >
                <span className="text-2xl group-hover:scale-110 transition-transform">
                  🔗
                </span>
            ...
            <div className="rounded-2xl border border-white/8 bg-white/3 p-4">
              ...
              <form onSubmit={handleJoin} className="flex gap-2">
                ...
                <button
                  type="submit"
                  className="px-4 py-2 rounded-xl bg-purple-600 hover:bg-purple-500 font-semibold text-sm transition-all active:scale-95"
                >
                  Git
                </button>
              </form>
                  ...
                  >
                    {game.available ? (
                      ...
                      <div className="rounded-2xl border border-white/5 bg-white/2 p-4 text-center opacity-50 cursor-not-allowed">
                        ...
                        <span className="mt-2 inline-block text-xs px-2 py-0.5 rounded-full bg-gray-700/30 text-gray-500 border border-gray-700/30">
                          Yakında
                        </span>
                      </div>
                    )}
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <div className="text-xs text-gray-500">
                            Host:{" "}
                            {room.host?.profile?.displayName ||
                              room.host?.username}
                            {" · "}
                            {room.gameType === "vampire-village"
                              ? "Vampir Köylü"
                              : room.gameType || "Oyun seçilmedi"}
                          </div>
                        </div>
                      </div>
                      <div className="flex items-center gap-3">
                        ...
                        <button
                          onClick={async () => {
                            try {
                              ...
                              toast.error(
                                err?.response?.data?.message || "Katılamadın",
                              );
                            }
                          }}
