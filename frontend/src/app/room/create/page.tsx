              ...
              <div className="grid grid-cols-2 gap-2">
                {GAME_TYPES.map((game) => (
                  <button
                    ...
                    onClick={() =>
                      game.available && setForm({ ...form, gameType: game.id })
                    }
                  ...
                  >
                    ...
                    <div>
                      ...
                      {!game.available && (
                        <div className="text-xs text-gray-600">Yakında</div>
                      )}
                    </div>
                  </button>
                ))}
            ...
            <div className="flex items-center justify-between p-4 rounded-xl border border-white/8 bg-white/3">
              <div>
                ...
                <div className="text-xs text-gray-500">
                  Sadece davet/kod ile katılınabilir
                </div>
              </div>
              <button
                type="button"
              ...
              >
                <span
                  className={`absolute top-1 w-4 h-4 rounded-full bg-white shadow transition-all ${form.isPrivate ? "left-7" : "left-1"}`}
                />
              </button>
            </div>
