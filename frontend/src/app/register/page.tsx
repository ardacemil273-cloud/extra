      ...
      >
        ...
        <div className="rounded-2xl border border-white/8 bg-white/3 backdrop-blur-xl p-8">
          ...
          <div className="mt-4 text-center">
            <Link
              href="/guest"
              className="w-full block py-3 rounded-xl font-medium border border-white/10 bg-white/3 hover:bg-white/8 transition-all text-sm text-gray-400"
            >
